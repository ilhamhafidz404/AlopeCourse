              ...
              <div class="row align-items-center">
                ...
                <div class="col-4 text-right">
                  <ul class="d-flex">
                    ...
                    <li class="me-2">
                      <span class="badge" style="background-color: {{$tag->badge}} !important ">
                        {{$tag->nama}}
                      </span>
                    </li>
                    @endforeach
        ...
        <div class="row align-items-center justify-content-lg-between">
          ...
          <div class="col-lg-6">
            <ul class="nav nav-footer justify-content-center justify-content-lg-end">
              ...
              <li class="nav-item">
                <a href="https://github.com/creativetimofficial/argon-admin/blob/master/LICENSE.md" class="nav-link" target="_blank">MIT License</a>
              </li>
            </ul>
          </div>
        </div>
